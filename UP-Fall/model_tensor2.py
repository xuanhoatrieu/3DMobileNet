...
from tensorflow.keras.layers import Input, Conv3D, BatchNormalization, MaxPooling3D, Activation, ReLU, GlobalAveragePooling3D
from tensorflow.keras.layers import Dense, GlobalMaxPooling3D
...
def _depthwise_conv_block(inputs, pointwise_conv_filters, alpha,
    ...
    x = Conv3D(inputs.shape[-1], kernel_size=(3, 3, 3), strides=strides, padding='same', groups=inputs.shape[-1],
